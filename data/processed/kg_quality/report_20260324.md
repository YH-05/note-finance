...
**Timestamp**: 2026-03-24T05:54:37.959006+00:00
...
| Avg Degree | 14.79 | count | green |
| Connected Ratio | 0.9985 | ratio | green |
| Orphan Ratio | 0.0015 | ratio | green |
...
| Metric | Value | Unit | Status |
|--------|------:|------|--------|
| Avg Freshness (days) | 4.8 | days | green |
...
| Metric | Value | Unit | Status |
|--------|------:|------|--------|
| Avg Path Length | 3.77 | hops | green |
| Path Diversity | 0.025 | ratio | red |
