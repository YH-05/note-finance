...
**Timestamp**: 2026-03-23T13:55:52.406340+00:00
**Overall Score**: 54.3 / 100.0
**Rating**: C
...
| Connected Ratio | 0.9988 | ratio | green |
| Orphan Ratio | 0.0012 | ratio | green |
...
| Metric | Value | Unit | Status |
|--------|------:|------|--------|
| Factual Correctness | 0.0 (stub) | ratio | yellow |
...
| Metric | Value | Unit | Status |
|--------|------:|------|--------|
| Avg Path Length | 3.78 | hops | green |
| Path Diversity | 0.0251 | ratio | red |
