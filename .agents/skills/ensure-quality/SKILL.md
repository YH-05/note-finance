...
- **GEMINI.md の規約に従う**: 型ヒント、エラーメッセージ、コーディングスタイルは GEMINI.md の規約に準拠
...
- `template/`: 実装例
- `.agents/agents/quality-checker/`: 品質修正エージェント
- `.agents/agents/code-simplifier/`: コード整理エージェント
