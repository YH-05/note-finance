...
> **⚠️ /save-to-graph（research-neo4j 専用, bolt://localhost:7688）は使用禁止。creator-neo4j へのデータ投入には必ず `/save-to-creator-graph` スキル（.gemini/commands/save-to-creator-graph.toml）を使うこと。**
