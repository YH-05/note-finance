# KG ギャップ分析レポート: BlackRock Q1 2026 決算レビュー（再リサーチ版）

> 初回作成: 2026-04-14 JST（プレビュー段階）
> 更新: 2026-04-15 JST（実績データ版）
> 対象: research-neo4j (bolt://localhost:7687)
> キーワード: BlackRock, BLK, AUM, 資産運用, Private Credit, iShares

## 2026-04-15 更新サマリー

前回プレビュー段階のギャップはほぼ全て解消済み。詳細は research_notes.md 参照。
- ✅ EPS実績 $12.53（+8.6%ビート）
- ✅ AUM $13.89T（予想$14.21Tをミス、市場下落が主因）
- ✅ パフォーマンスフィー$272M（前年比+353%）
- ✅ 純流入$130B（iShares ETF主導）
- ✅ プライベートマーケット解約ゲート詳細
