...
> ⚠️ **非推奨**: このコマンドは非推奨です。代わりに `/article-draft` + `/article-critique` を使用してください。
...
5. 記事ルート内の `02_draft/first_draft.md` を編集対象とする
...
2. **finance-article-writer 実行**
   ...
   Output: 02_draft/first_draft.md
   ```
...
10. **finance-reviser 実行**
    ...
    Output: 02_draft/revised_draft.md
    ```
