...
### バリエーション A: 全体図（冒頭ヒーロー用 / 1920x1080px 横長 16:9）
...
### バリエーション B: クローズアップ（解説内用 / 1920x1080px 横長 16:9）
...
Color palette: vivid lavender, hot rose pink, luminous cream, brilliant gold, electric periwinkle, coral accents.
Composition: horizontal 16:9 format (1920x1080px). A cropped, intimate view focusing on {detail_focus}. The zodiac constellation "{zodiac_name}" faintly visible as glowing gold dots in one corner. No border. No text.
...
3. 画像生成AIに貼り付けて生成（1920x1080px / 横長 16:9）
...
| 要素 | 統一ルール |
|------|----------|
| 画風 | 鮮やかなパステル水彩（vibrant pastel watercolor） |
| 色調 | ビビッドラベンダー、ホットローズ、ルミナスクリーム、ブリリアントゴールド、エレクトリックペリウィンクル、コーラル |
| 雰囲気 | 温かい、夢想的だが目を引く（warm, dreamy yet eye-catching） |
| 枠線 | 薄い金色のエレガントなボーダー（全体図のみ） |
| テキスト | 画像内にテキストなし（サムネイルで別途合成） |
| トーン | 怖くない。全星座を肯定的・内省的だがビジュアル的に華やかに表現 |
| 星座記号 | 星座の星の並びを**明るい金色ドット+光る線で接続**し、背景にくっきり表示 |
