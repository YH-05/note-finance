...
**入力**: `articles/weekly_report/{date}/data/` 配下の複数 JSON
...
python scripts/emit_graph_queue.py \
  ...
  --input articles/weekly_report/2026-03-05/data/
```
...
| generate-market-report | Phase 7 末尾 | `articles/weekly_report/{date}/data/` | +5行 |
